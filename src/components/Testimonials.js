    ...
    <div className="w-full h-screen">
      ...
      <ParallaxLayer offset={3} speed={0}>
        <div className="bg-myorange w-full h-full z-0">
          <h1 className="text-6xl sm:text-9xl text-center text-white font-thin pt-10">Testimonial</h1>
        </div>
      </ParallaxLayer>
        ...
        {data.testimonialData?.map((t, index) => (
          <ParallaxLayer offset={index} speed={1} key={index}>
            <div className="w-full h-screen flex items-center justify-center bg-mygreen">
              <div>
                <div className="flex-none carousel-item w-[280px] sm:w-[350px] h-auto p-5 md:p-8 mx-3 glass  rounded-md hover:scale-125 cursor-pointer transition-all duration-500">
